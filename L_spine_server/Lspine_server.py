...
app.mount("/static", StaticFiles(directory="../L_spine/static"), name="static")
app.mount("/images", StaticFiles(directory="../L_spine/images"), name="images")
# app.mount("/static", StaticFiles(directory="/app/L_spine/static"), name="static")
# app.mount("/images", StaticFiles(directory="/app/L_spine/images"), name="images")
...
async def serve_index():
    ...
    current_directory = os.path.join(os.path.dirname(__file__), '..', 'L_spine')
